...
* Please **do not** use the issue tracker for personal support requests.  
  Use [discussions](https://github.com/telepathics/yourls-ref-checkpoint/discussions) instead to ask the community for help.
...
2. **Licensing**  
   ...
   [MIT License](https://github.com/telepathics/yourls-ref-checkpoint/blob/master/LICENSE) terms.
3. **Coding Standards**  
